...
<html lang="it">
  <head>
    ...
    <title>EpSolar Tracer Stats Dashboard</title>
...
<div class="centered">
<div class="inner">
<p style="	font-family: verdana,arial,sans-serif; font-size:16px; font-weight:bold;">EpSolar Tracer Dashboard</p>
...
<table class="gridtable">
<tr>
	<th colspan=2>-= Tracer Stats =-</th>
</tr>
<?php
$tracer->getStatData();
for ($i = 0; $i < count($tracer->statData); $i++) {
	print "<tr><td class=\"bold\">{$tracer->statKey[$i]}</td><td class=\"data\">{$tracer->statData[$i]}{$tracer->statSym[$i]}</td></tr>";
}
?>
...
<table class="gridtable">
<tr>
        <th colspan=2>-= Tracer Settings =-</th>
</tr>
<?php
$tracer->getSettingData();
for ($i = 0; $i < count($tracer->settingData); $i++) {
        print "<tr><td class=\"bold\">{$tracer->settingKey[$i]}</td><td class=\"data\">{$tracer->settingData[$i]}{$tracer->settingSym[$i]}</td></tr>";
}
?>
</table>
